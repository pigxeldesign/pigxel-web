/*
  # Fix dapp_with_categories view and remove unused columns

  1. Changes
     - Safely drop unused columns from dapps table if they exist
     - Recreate dapp_with_categories view without referencing the rating column
...
-- Create the view without referencing the rating column
