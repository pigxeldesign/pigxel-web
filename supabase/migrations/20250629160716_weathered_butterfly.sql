/*
  ...
  1. Changes
     - Drop the `rating` and `user_count` columns from the `dapps` table
     - Update the `dapp_with_categories` view to remove these columns
  
  2. Fix
     - First drop the view that depends on these columns
     - Then drop the columns
     - Finally recreate the view without the removed columns
*/
