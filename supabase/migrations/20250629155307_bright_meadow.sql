/*
  ...
  1. Changes
     - Removes references to non-existent columns (rating, user_count)
     - Safely drops unused columns if they exist
     - Recreates the view with only existing columns

  2. Safety
     - Uses IF EXISTS checks for all operations
