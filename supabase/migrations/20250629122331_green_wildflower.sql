/*
  # Clean up dapps table and recreate view

  1. Schema Cleanup
    - Safely drop unused columns from dapps table if they exist
    - Only include existing columns in the view

  2. View Recreation
    - Drop and recreate dapp_with_categories view
    - Only include columns that actually exist in the dapps table
    - Join with categories table for category information
*/
