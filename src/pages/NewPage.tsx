...
const NewPage: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      console.log('Loaded new dApps:', transformedDApps);
    } catch (err: any) {
      if (!isProduction()) {
      ...
      setError('Failed to load new dApps. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="pt-16 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading new dApps...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="pt-16 min-h-screen flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <h1 className="text-2xl font-bold text-white mb-4">Error Loading New dApps</h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 text-lg sm:text-xl mb-6">
              Discover the latest decentralized applications that have recently joined our directory
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm text-gray-400 mb-6">
              <span>
                Showing {Math.min(startIndex + 1, filteredDApps.length)}-{Math.min(endIndex, filteredDApps.length)} of {filteredDApps.length} new dApps
              </span>
              {totalPages > 1 && (
          ...
          {filteredDApps.length === 0 ? (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2">No new dApps found</h3>
              <p className="text-gray-400 mb-6">
                {hasActiveFilters 
                  ? 'Try adjusting your filters to find new dApps.'
                  : 'No new dApps are currently available.'
                }
              </p>
              {hasActiveFilters && (
                <button
