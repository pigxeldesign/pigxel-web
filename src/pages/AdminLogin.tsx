...
const AdminLogin: React.FC = () => {
  ...
  const { user, isAdmin, signIn, signInWithGoogle } = useAuth();
      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-6 flex items-center justify-center space-x-3 px-4 py-3 bg-white hover:bg-gray-50 text-gray-900 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
